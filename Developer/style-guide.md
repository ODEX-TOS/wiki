...
[](#opening-scope) Opening a new scope should always be on the previous line. Unless the language forbids it.
...
[](#constants) Constant variables as well as environment variables should be all capital letters
###### Right:
```bash
